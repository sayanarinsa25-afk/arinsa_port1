...
,
  ...
  mediaType: "video",
  mediaSrc: "/video/Asda.mp4", // replace with actual video
...
,{
  ...
  mediaType: "video",
  poster: "/image/Eco-thumbnail.jpg",
  mediaSrc: "/video/Eco.mp4", 
...
,
{
  ...
  mediaType: "video",
  poster: "/image/Lhv-thumbnail.png",
  mediaSrc: "/video/Lhv.mp4", 
...
,
{
  ...
  mediaType: "video",
  poster: "/image/Manjehealth-thumbnail.jpg",
  mediaSrc: "/video/Manjehealth.mp4", 
...
,{
  ...
  mediaType: "video",
  poster: "/image/Coles-thumbnail.png",
  mediaSrc: "/video/Coles.mp4",
...
,
{
  ...
  mediaType: "video",
  poster: "/image/Styledotme-thumbnail.jpg",
  mediaSrc: "/video/Styledotme.mp4",
...
,{
  ...
  mediaType: "video",
  poster: "/image/Nubank-thumbnail.jpg",
  mediaSrc: "/video/Nubank.mp4",
...
,{
  ...
  mediaType: "video",
  poster: "/image/Mynabolo-thumbnail.jpg",
  mediaSrc: "/video/Mynabolo.mp4",
...
,
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-10">
      <p>
        <strong>Arinsa Multi-Agent</strong> is a cutting-edge framework that
        enables autonomous collaboration between specialized AI agents,
        functioning as a digital workforce for enterprises. Each agent is
        designed to handle complex departmental tasks while seamlessly
        communicating with other agents to ensure efficiency, compliance, and
        scalability.
      </p>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Sales Agent – Intelligent Revenue Growth
        </h3>
        <p>
          The Sales Agent autonomously identifies leads, drafts outreach
          messages, personalizes pitches, and tracks conversions.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Lead Generation:</strong> Analyzes CRM and market data to identify prospects.</li>
          <li><strong>Personalized Outreach:</strong> Drafts contextual messages and proposals.</li>
          <li><strong>Impact:</strong> 45% increase in qualified lead conversions.</li>
        </ul>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Finance Agent – Autonomous Financial Operations
        </h3>
        <p>
          The Finance Agent automates reporting, budgeting, and compliance
          checks, ensuring financial transparency and accuracy.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Automated Reporting:</strong> Real-time dashboards and statements.</li>
          <li><strong>Compliance Monitoring:</strong> AI-driven audits and fraud detection.</li>
          <li><strong>Impact:</strong> 60% reduction in manual financial overhead.</li>
        </ul>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Support Agent – AI-Powered Customer Assistance
        </h3>
        <p>
          The Support Agent delivers 24/7 multi-channel customer assistance with
          human-like contextual understanding.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Multi-Lingual Chat:</strong> Supports queries in 50+ languages.</li>
          <li><strong>Context-Aware Helpdesk:</strong> Personalized responses based on customer history.</li>
          <li><strong>Impact:</strong> 70% decrease in first-response time.</li>
        </ul>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Legal Agent – AI Compliance & Contract Review
        </h3>
        <p>
          The Legal Agent assists enterprises by reviewing contracts, ensuring
          compliance, and flagging risks.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Contract Analysis:</strong> Identifies clauses, obligations, and risks.</li>
          <li><strong>Regulatory Compliance:</strong> Automated cross-checks against policies.</li>
          <li><strong>Impact:</strong> 50% faster contract review cycles.</li>
        </ul>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Doc-Tracker Agent – Intelligent Document Workflow
        </h3>
        <p>
          The Doc-Tracker Agent ensures smooth documentation flow across
          departments with automated approvals and tracking.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Version Control:</strong> Tracks document edits and approvals.</li>
          <li><strong>Workflow Automation:</strong> Reduces bottlenecks in multi-team reviews.</li>
          <li><strong>Impact:</strong> 65% improvement in document turnaround times.</li>
        </ul>
      </div>
      ...
      <div>
        <h3 className="text-2xl font-bold text-gray-900">
          Research Agent – Knowledge & Insights Generator
        </h3>
        <p>
          The Research Agent collects, analyzes, and summarizes data across
          multiple sources to deliver actionable insights.
        </p>
        <ul className="list-disc list-inside space-y-2 mt-2">
          <li><strong>Multi-Source Mining:</strong> Extracts from academic papers, market data, and reports.</li>
          <li><strong>Insight Generation:</strong> Produces concise, structured research summaries.</li>
          <li><strong>Impact:</strong> 55% faster research-to-decision cycles.</li>
        </ul>
      </div>

      <p className="mt-6">
        Together, these agents form the <strong>Arinsa Multi-Agent Workforce</strong>,
        showcasing how <strong>Arinsa AI Minds</strong> is building the future of
        enterprise automation—autonomous, collaborative, and scalable AI teams
        that operate across departments seamlessly.
      </p>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/Arinsa-MultiAgent.mp4", // replace with actual showcase video
  poster: "/image/Arinsa-MultiAgent-thumbnail.png",
...
// AutoDocQuery
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        AutoDocQuery is your all-in-one AI document assistant, built to extract,
        analyze, and summarize knowledge from multiple files in real time. 
        Whether for research, compliance, or decision-making, it demonstrates 
        how semantic retrieval and contextual summarization can transform scattered 
        data into clear, actionable insights.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Semantic Retrieval:</strong> Delivers precise, context-aware answers instead of plain keyword matches.</li>
        <li><strong>Multi-Format Handling:</strong> Works seamlessly across PDFs, Word, Excel, and even web content.</li>
        <li><strong>Contextual Summaries:</strong> Turns complex documents into structured, easy-to-digest overviews.</li>
        <li><strong>Proven Impact:</strong> Demonstrates a 50%+ reduction in research and review time.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/AutoDocQuery.mp4",
  poster: "/image/AutoDocQuery-thumbnail.jpg",
},
...
// CodeSimplify
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        CodeSimplify demonstrates the power of AI to automate developer workflows by instantly converting raw codebases into clear, structured documentation. 
        Ideal for engineering teams, it enables faster onboarding, easier maintenance, and improved code understanding without manual effort.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Intelligent Code Parsing:</strong> Analyzes functions, APIs, and logic flow to generate meaningful structure.</li>
        <li><strong>Natural Language Documentation:</strong> Converts complex code into clear explanations in plain English.</li>
        <li><strong>Multi-Language Support:</strong> Works seamlessly across Python, Java, JavaScript, and more.</li>
        <li><strong>Proven Impact:</strong> Speeds up developer onboarding by up to 40%, reducing manual documentation effort.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/CodeSimplify.mp4",
  poster: "/image/CodeSimplify-thumbnail.jpg",
},
...
// InstaCoder
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        InstaCoder showcases the power of AI to supercharge developer productivity by providing real-time assistance within coding environments.
        It intelligently suggests code completions, automatically fixes errors, and generates useful code snippets on demand — helping developers
        focus on solving problems faster without context switching.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Context-Aware Suggestions:</strong> Provides intelligent, real-time code completions inside popular IDEs.</li>
        <li><strong>Automated Debugging:</strong> Quickly detects and resolves common coding errors, reducing debugging time.</li>
        <li><strong>Snippet Generator:</strong> Generates reusable functions and test cases instantly based on context.</li>
        <li><strong>Proven Impact:</strong> Demonstrates up to a 35% increase in coding speed and developer efficiency.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/InstaCoder.mp4",
  poster: "/image/InstaCoder-thumbnail.jpg",
},
// TransCoder
{
  id: 20,
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        TransCoder demonstrates the power of AI to modernize legacy codebases by automatically translating them across programming languages.
        It preserves the original logic and structure, reducing the cost, effort, and risk of manual rewriting. Perfect for organizations 
        looking to upgrade systems or bridge language gaps without losing functionality.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Automated Code Conversion:</strong> Translates code between Python, Java, C++, and other languages accurately.</li>
        <li><strong>Logic Preservation:</strong> Ensures functional integrity is maintained during translation.</li>
        <li><strong>Migration Support:</strong> Demonstrates seamless legacy-to-modern system transitions.</li>
        <li><strong>Proven Impact:</strong> Reduces development effort by up to 60%, accelerating modernization projects.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/TransCoder.mp4",
  poster: "/image/TransCoder-thumbnail.jpg",
},
...
// TextifyAI
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        TextifyAI demonstrates how generative AI can produce both creative and functional text content instantly.
        From engaging blog posts to precise technical documents, it adapts tone, style, and domain-specific language to meet any requirement.
        Ideal for marketers, developers, and content teams aiming to accelerate content creation with consistent quality.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Automated Content Generation:</strong> Produces blogs, marketing copy, and technical docs effortlessly.</li>
        <li><strong>Domain-Specific Customization:</strong> Fine-tuned models deliver content tailored to industries like healthcare, finance, and tech.</li>
        <li><strong>Multi-Lingual Support:</strong> Generates text in several global languages to reach diverse audiences.</li>
        <li><strong>Proven Impact:</strong> Enables up to 70% faster content delivery, streamlining workflows and reducing manual effort.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/TextifyAI.mp4",
  poster: "/image/TextifyAI-thumbnail.jpg",
},
...
// Text2Vision
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        Text2Vision demonstrates how generative AI empowers creative industries by converting natural language prompts into visuals.
        It accelerates design workflows, enabling rapid prototyping, marketing visuals, and storytelling concepts without manual design effort.
        Perfect for designers, marketers, and content creators seeking fast, high-quality visual generation.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Image Synthesis:</strong> Generates visuals directly from natural language prompts with high fidelity.</li>
        <li><strong>Flexible Style Options:</strong> Outputs range from realistic images to abstract art, tailored to project needs.</li>
        <li><strong>Creative Use Cases:</strong> Ideal for advertisements, product prototypes, concept art, and storyboarding.</li>
        <li><strong>Proven Impact:</strong> Speeds up creative turnaround while lowering design costs significantly.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/Text2Vision.mp4",
  poster: "/image/Text2Vision-thumbnail.jpg",
},

{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        SummarizerPro analyzes video transcripts to generate concise highlight reels and structured summaries. Ideal for webinars,
        lectures, and long-form video content, it enables fast extraction of key insights, accelerating decision-making without watching
        entire videos.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Automatic Transcript Analysis:</strong> Extracts meaning and structure from video transcripts.</li>
        <li><strong>Highlight Generation:</strong> Produces digestible video summaries from hours of footage.</li>
        <li><strong>Impact:</strong> Reduces video review time by up to 70%, increasing productivity.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/SummarizerPro-Video.mp4",
...
},
{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        SummarizerPro converts lengthy audio recordings into structured summaries by analyzing speech transcripts.
        Perfect for meetings, interviews, and podcasts, it helps extract important points and actionable takeaways,
        reducing the need to listen to full recordings.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Speech-to-Text Analysis:</strong> Converts spoken content into structured insights.</li>
        <li><strong>Key Point Extraction:</strong> Summarizes main ideas and action items from audio files.</li>
        <li><strong>Impact:</strong> Cuts down audio review time by up to 60%, enhancing workflow efficiency.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/SummarizerPro-Audio.mp4",
  poster: "/image/SummarizerPro-thumbnail.jpg",
},
{
  id: 25,
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-4">
      <p>
        SummarizerPro intelligently summarizes long-form text documents, articles, and reports by extracting key ideas and structuring
        them into concise insights. Designed for researchers, legal teams, and content creators, it eliminates manual reading time and
        boosts productivity.
      </p>
      <ul className="list-disc list-inside space-y-2 mt-2">
        <li><strong>Document Analysis:</strong> Summarizes PDFs, Word docs, and web articles into structured overviews.</li>
        <li><strong>Customizable Summaries:</strong> Adjustable summary length and tone per user needs.</li>
        <li><strong>Impact:</strong> Reduces reading time by up to 60%, improving efficiency in research-heavy tasks.</li>
      </ul>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/SummarizerPro-Text.mp4",
  poster: "/image/SummarizerPro-thumbnail.jpg",
}
,
...
<p>
<strong>AI Maker Pro</strong> is an advanced generative AI platform
        developed by <strong>Arinsa AI Minds</strong> that enables users to
        transform text prompts into high-quality visuals in seconds. Built for
        designers, marketers, and storytellers, it bridges creativity and
        technology by making image generation simple, fast, and versatile.
</p>
 
      <h3 className="text-2xl font-bold text-gray-900">Key Features</h3>
<ul className="list-disc list-inside space-y-2">
<li>
<strong>Natural Language to Image:</strong> Converts descriptive text
          into detailed, high-resolution visuals.
</li>
<li>
<strong>Creative Flexibility:</strong> Supports multiple styles,
          including realistic, abstract, anime, and artistic.
</li>
<li>
<strong>Custom Parameters:</strong> Adjust resolution, aspect ratio,
          and artistic filters for tailored outputs.
</li>
<li>
<strong>Instant Generation:</strong> Optimized pipelines for fast,
...
<ul className="list-disc list-inside space-y-2">
<li>
<strong>For Designers:</strong> Accelerates ideation and prototyping.
</li>
<li>
<strong>For Marketing:</strong> Generates unique ad creatives and
          campaign visuals.
</li>
<li>
<strong>For Storytelling:</strong> Brings narratives to life with
          immersive imagery.
</li>
<li>
<strong>Productivity Gains:</strong> Reduced design cycles by 65%.
</li>
</ul>
 
      <p className="mt-6">
        With <strong>AI Maker Pro</strong>, <strong>Arinsa AI Minds</strong>
        continues to push the boundaries of generative AI, offering a powerful
        yet easy-to-use tool that democratizes creativity and accelerates visual
        innovation.
</p>
</div>
  ),
...

{
  ...
  description: (
    <div className="text-gray-700 leading-relaxed space-y-6">
      <p>
        <strong>Wealthfront</strong> is a modern, AI-driven investment platform
        designed to simplify wealth management. By combining personalized
        financial planning with automated investing, it helps individuals grow
        their money, plan for future goals, and manage finances with ease—all in
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Automated Investing:</strong> Professionally designed
          portfolios tailored to user risk profiles and goals.
        </li>
        <li>
          <strong>Financial Planning:</strong> Goal-based planning for
          retirement, buying a home, or saving for education.
        </li>
        <li>
          <strong>Cash Management:</strong> High-yield accounts with seamless
          money movement.
        </li>
        <li>
          <strong>Tax-Loss Harvesting:</strong> Smart automation to optimize tax
          savings and improve after-tax returns.
        </li>
        <li>
          <strong>Mobile-First Experience:</strong> Intuitive app for
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>
          <strong>Financial Accessibility:</strong> Brings professional-grade
          wealth management to everyday investors.
        </li>
        <li>
          <strong>Cost Efficiency:</strong> Lower fees compared to traditional
          advisors, making investing more affordable.
        </li>
        <li>
          <strong>Smart Growth:</strong> Data-driven strategies enhance
          long-term wealth accumulation.
        </li>
        <li>
          <strong>User Empowerment:</strong> Simplifies decision-making with
          automated, goal-oriented tools.
        </li>
      </ul>

      <p className="mt-6">
        With <strong>Wealthfront</strong>, users experience the future of
        personal finance—where automation, AI, and smart planning come together
        to build wealth with confidence and ease.
      </p>
    </div>
  ),
  mediaType: "video",
  mediaSrc: "/video/Wealthfront.mp4", // replace with actual showcase demo video
    ...
    <div className="w-full min-h-screen bg-gray-50 text-gray-900">
      ...
      <section className="w-full py-16 px-6 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            <div className="relative w-48 h-48 md:w-56 md:h-56 shrink-0 rounded-full border-4 border-white shadow-[0_0_25px_rgba(168,85,247,0.6)]">
  <Image
    ...
    {projects.map((project) => (
      ...
      >
        <CardContent className="p-6">
          ...
          {/* ✅ Media Preview */}
          <div className="relative w-full h-40 rounded-lg mb-4 overflow-hidden bg-gray-200 group">
            {project.mediaType === "video" ? (
              <Image
                src={project.poster || "/image/video-fallback.png"}
            ...
            {project.mediaType === "video" && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="rounded-full bg-black/50 p-3 transition group-hover:scale-110">
                  <svg
      ...
      >
        ...
        >
          ...
          <div className="p-8 overflow-y-auto">
            ...
            {/* ✅ Media Section with autoplay video */}
